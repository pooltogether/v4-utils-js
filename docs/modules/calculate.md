...
[calculate/calculateCardinality.ts:6](https://github.com/pooltogether/v4-js/blob/fc653a7/src/calculate/calculateCardinality.ts#L6)
...
[calculate/calculateFractionOfPrize.ts:4](https://github.com/pooltogether/v4-js/blob/fc653a7/src/calculate/calculateFractionOfPrize.ts#L4)
...
[calculate/calculateNormalizedBalancePicksFromTotalPicks.ts:3](https://github.com/pooltogether/v4-js/blob/fc653a7/src/calculate/calculateNormalizedBalancePicksFromTotalPicks.ts#L3)
...
[calculate/calculateNumberOfMatches.ts:5](https://github.com/pooltogether/v4-js/blob/fc653a7/src/calculate/calculateNumberOfMatches.ts#L5)
...
[calculate/calculateNumberOfPrizesForTierIndex.ts:1](https://github.com/pooltogether/v4-js/blob/fc653a7/src/calculate/calculateNumberOfPrizesForTierIndex.ts#L1)
...
[calculate/calculatePick.ts:6](https://github.com/pooltogether/v4-js/blob/fc653a7/src/calculate/calculatePick.ts#L6)
...
[calculate/calculatePicks.ts:6](https://github.com/pooltogether/v4-js/blob/fc653a7/src/calculate/calculatePicks.ts#L6)
...
[calculate/calculatePicksFromAverageTotalSuppliesBetween.ts:7](https://github.com/pooltogether/v4-js/blob/fc653a7/src/calculate/calculatePicksFromAverageTotalSuppliesBetween.ts#L7)
...
[calculate/calculatePrizeForTierPercentage.ts:6](https://github.com/pooltogether/v4-js/blob/fc653a7/src/calculate/calculatePrizeForTierPercentage.ts#L6)
...
[calculate/calculateTierIndexFromMatches.ts:1](https://github.com/pooltogether/v4-js/blob/fc653a7/src/calculate/calculateTierIndexFromMatches.ts#L1)
