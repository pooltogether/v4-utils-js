...
import { createContract, createInterface, getProviderFromChainId, validateContractListIsConnected } from "../../src";
...
describe("validateContractListIsConnected", () => {
  ...
  it("should succed to validate connected contract list", () => {
    const ABI: any = []
    const contracts: Array<Contract | undefined> = [
      createContract(ADDRESS_DEAD, createInterface(ABI), getProviderFromChainId(1)),
    ]
